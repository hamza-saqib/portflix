...
@section('title-meta')
    <title>{{ env('APP_NAME', 'Admin') }} | Theme Create</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
                            <h5>Theme <small>from here you can create your new Theme.</small></h5>
                        ...
                        <div class="ibox-content">
                            <form method="POST" action="{{ route('admin.theme.store') }}" class="form-horizontal"
