        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-8">
                <div class="title-action">
                    <a href="{{ route('admin.product.category.index') }}" class="btn btn-primary">Show List</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
                            <h5>Category <small>from here you can edit your product category.</small></h5>
                        ...
                        <div class="ibox-content">
                            <form method="POST" action="{{ route('admin.product.category.update', $productCategory->id) }}" class="form-horizontal"
