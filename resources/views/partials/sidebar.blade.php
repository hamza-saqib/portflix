<ul class="profile_details pl-0 ">
    <li class="pt-3"> <a href="{{route('profile.basic')}}" class="text-decoration-none"> Basic Info</a></li>
    <li class="pt-2"> <a href="{{route('profile.educational')}}" class="text-decoration-none"> Education</a></li>
    <li class="pt-2"> <a href="{{route('profile.industry')}}" class="text-decoration-none">
